...
**In progress — phase 1 landed:** [`Foundation/StructuralCrownSentence.lean`](../../../../NoveltyTheory/Foundation/StructuralCrownSentence.lean), [`Models/StructuralCrownFamily.lean`](../../../../NoveltyTheory/Models/StructuralCrownFamily.lean), [`Summits/StructuralCrownSummit.lean`](../../../../NoveltyTheory/Summits/StructuralCrownSummit.lean); inventory + [`docs/CROWN_*`](../../../../docs/CROWN_POSITIONING.md). Acceptance: conjunction witness is **not** `geOutput` and **not** `IsGeneratorStructural`; **stronger** anti-collapse than v1 if required by adversarial review → iterate here before **`SPEC_047`**.
