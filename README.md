...
**What this formalizes:** Novelty Theory (§C): fixed causal laws without final explanatory closure — explanatory anti-closure under exact generation.

| Link | Description |
|------|-------------|
| [Research page](https://www.novaspivack.com/research/) | Full index of all papers, programs, and Lean archives |
| [Full abstracts](https://novaspivack.github.io/research/abstracts/#novelty-theory) | Complete abstract for this library's papers |
...
- **Lean:** Mathlib **`v4.29.1`**, toolchain in [`lean-toolchain`](lean-toolchain) — [`docs/003_LEAN_TOOLCHAIN_PIN.md`](docs/003_LEAN_TOOLCHAIN_PIN.md).
- **Paper:** `paper/Final Draft/Self-Transcending_Generators.tex` and `refs.bib`. Build from that directory: [`paper/Final Draft/COMPILE.md`](paper/Final%20Draft/COMPILE.md).
