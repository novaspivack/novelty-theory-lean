...
- Post-closure program: **[`EPIC_009`](../specs/INCOMPLETE/IN-PROCESS/EPIC_009_STRICT_ITERATED_ASCENT/EPIC_009_MASTER_ORCHESTRATION.md)** (**`SPEC_035_GS1`**–**`SPEC_037_CR1`**, crown ascent), **[`EPIC_010`](../specs/INCOMPLETE/IN-PROCESS/EPIC_010_EXPRESSIVE_ORGANIZATION_FRONTIER/EPIC_010_MASTER_ORCHESTRATION.md)** (**`SPEC_038_XS1`**–**`SPEC_041_OR1`**, expressive frontier)
